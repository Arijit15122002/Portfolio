	...
	<div className='w-full h-auto bg-[#232323] dark:bg-white p-10 md:p-20 flex flex-col items-center'>
		<div className='w-full max-w-[1200px] flex flex-col bg-inherit'>
			<div className='w-full h-auto flex justify-end'>
				<div onClick={handleScrollToTop} className='flex flex-row items-center px-6 py-2 text-white dark:text-black font-semibold gap-2 rounded-xl shadow-md bg-black dark:bg-[#dddddd] shadow-black/40 hover:scale-110 duration-200 ease-in-out cursor-pointer'>
					<div>BACK TO TOP</div>
			...
			<div className='w-full flex flex-col  md:flex-row justify-between items-center'>
				<div className='flex flex-row gap-5 items-center'>
					<Link to={'https://github.com/Arijit15122002'} className='flex flex-row gap-2 px-4 py-2 dark:bg-[#d9d9d9] bg-[#111111] dark:text-[#232323] text-white rounded-full'>
					...
					<Link to={'https://www.linkedin.com/in/biswas2002/'} className='flex flex-row gap-2 px-4 py-2 dark:bg-[#d9d9d9] bg-[#111111] dark:text-[#232323] text-white rounded-full'>
