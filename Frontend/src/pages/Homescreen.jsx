	...
	<div className=''>
		<div className='pt-[60px] bg-inherit w-full h-[200vh] md:h-screen flex flex-col md:flex-row md:items-center md:justify-between'>
			<div className='w-[90%] sm:w-[80%] h-[95vh] md:w-[50%] md:h-[90%] flex items-center'>
				<div className='h-[90%] md:h-full w-full bg-[#232323] dark:bg-[#e7e7e7] rounded-r-2xl flex flex-col justify-center gap-5 z-10'>
					...
					<div className='flex flex-row ml-10 md:ml-16 gap-3'>
						<Link to={'https://www.facebook.com/profile.php?id=100034648763409'}>
						...
						<Link to={'https://www.instagram.com/chord_s_/'}>
						...
						<Link to={'https://www.linkedin.com/in/biswas2002/'}>
			...
			<div className='h-[100vh] md:h-auto md:w-[49%] flex flex-col items-center justify-center px-6'>
				<div className='h-auto w-full flex flex-col items-start customizedHidden1 z-0'>
				...
				<div>
					...
					<div to={'/contact'} className=' flex flex-row items-center justify-center w-full h-auto gap-5'>
						<Link to={'/contact'} className='text-[rgb(62,255,210)] bg-[#232323] dark:bg-[#101010] shadow-md shadow-[#232323] text-md px-4 py-2 font-bold cabin rounded-lg'>Catch me here</Link>
						<Link to={'/project'} className='border-[2px] border-[#232323] dark:border-[#dddddd] dark:text-white text-md px-5 py-[10px] anton rounded-lg'>More to know me?</Link>
					</div>
				</div>
			</div>
		</div>
